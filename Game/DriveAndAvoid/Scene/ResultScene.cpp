...
void ResultScene::Draw() const
{
	...
	DrawFormatString(300, 140, GetColor(255, 255, 255), "%05d × １０", score / 10 - itemcount_result * 150 - mosecount_result * 250);
	/*for (int i = 0; i < 3; i++)*/
	/*{
...
TRUE);		
	...
	DrawFormatString(270, 265, GetColor(255, 255, 255), "    = %d × ２５０", mosecount_result);
